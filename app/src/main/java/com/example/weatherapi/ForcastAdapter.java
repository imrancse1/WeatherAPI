...
import com.example.weatherapi.Forcast.City;
import com.example.weatherapi.Forcast.Weather;
...
public class ForcastAdapter extends RecyclerView.Adapter<ForcastAdapter.ForcastHolder>{
   private Context context;
    private java.util.List<com.example.weatherapi.Forcast.List> mainFeatures;
    private  java.util.List<Weather> weatherList;

    public ForcastAdapter(Context context, java.util.List<com.example.weatherapi.Forcast.List> mainFeatures
                              ) {
    ...
    public void onBindViewHolder(@NonNull ForcastHolder holder, int i) {
        final com.example.weatherapi.Forcast.List feature= mainFeatures.get(i);
